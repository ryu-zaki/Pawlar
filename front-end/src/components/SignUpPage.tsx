                    ...
                    <form onSubmit={handleSignUp} className="space-y-4 mx-7 mt-3">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`bg-white shadow text-[3.5vw] p-2 w-full h-10 rounded-[15px] mb-2 outline-gray-200 ${errors.firstName ? "border border-error-red" : ""
                                    }`}
                            ...
                            <input
                                ...
                                className={`bg-white shadow text-[3.5vw] p-2 w-full h-10 rounded-[15px] mb-1 outline-gray-200 ${errors.lastName ? "border border-error-red" : ""
                                    }`}
                            ...
                            <input
                                ...
                                type="text"
                                className={`bg-white shadow text-[3.5vw] p-2 w-full h-10 rounded-[15px] mb-1 outline-gray-200 ${errors.email ? "border border-error-red" : ""
                                    }`}
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className={`bg-white shadow text-[3.5vw] p-2 w-full h-10 rounded-[15px] mb-1 outline-gray-200 ${errors.password ? " border border-error-red" : ""
                                        }`}
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className={`bg-white shadow text-[3.5vw] p-2 w-full h-10 rounded-[15px] mb-2 outline-gray-200 ${errors.confirmPassword ? "border border-error-red" : ""
                                        }`}
